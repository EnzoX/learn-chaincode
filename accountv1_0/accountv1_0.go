...
// ============================================================================================================================
func (t *SimpleChaincode) transfer_balance(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	if err != nil {
		return shim.Error("Failed to get the second account")
	}
	resB := Account{}
	...
	if (BalanceA - amount) < 0 {
		return shim.Error(args[0] + " doesn't have enough balance to complete transaction")
	}
